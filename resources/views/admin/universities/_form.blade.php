    ...
    <div>
        ...
        <div class="mb-5 flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ __('Enter the main information about this university.') }}
                </p>
            ...
            @else
                ...
                <div class="rounded-lg bg-teal-50 p-4 dark:bg-teal-900/20">
                    ...
                    <div class="flex gap-3">
                        ...
                        <svg class="mt-0.5 h-5 w-5 shrink-0 text-teal-600 dark:text-teal-400"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-teal-700 dark:text-teal-400">
                                {{ __('The slug will be automatically generated from the university name.') }}
                            </p>
        ...
        <div class="mt-5">
            ...
            <textarea
                ...
                name="description"
                rows="6"
                placeholder="{{ __('Write a description about this university...') }}"
                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:placeholder-gray-500"
    ...
    <div class="border-t border-gray-200 pt-8 dark:border-gray-700">
        ...
        <div class="mb-5 flex items-center gap-3">
            ...
            <div class="flex h-9 w-9 items-center justify-center rounded-lg bg-teal-100 dark:bg-teal-900/50">
                ...
                <svg class="h-5 w-5 text-teal-600 dark:text-teal-300"
                    ...
                    <path stroke-linecap="round"
                        stroke-linejoin="round"
                        stroke-width="2"
                        d="M13.5 16.5h-3v-9h3m-3 4.5h3M5 3h14a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2z">
                    </path>
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ __('Configure the university website, status and display order.') }}
                </p>
        ...
        <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    {{ __('Enter the official university website URL.') }}
                </p>
            ...
            <div>
                ...
                <select
                    ...
                    name="status"
                    required
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300"
                >

                    <option
                        value="active"
                        @selected(old('status', $university->status ?? 'active') === 'active')
                    >
                        {{ __('Active') }}
                    </option>
                    ...
                    <option
                        value="inactive"
                        @selected(old('status', $university->status ?? '') === 'inactive')
                    >
                        {{ __('Inactive') }}
                    </option>
            ...
            <div>
                ...
                <input
                    ...
                    type="number"
                    min="0"
                    value="{{ old('sort_order', $university->sort_order ?? 0) }}"
                    placeholder="{{ __('0') }}"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:placeholder-gray-500"
                >

                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    {{ __('Lower numbers are displayed first.') }}
                </p>
    ...
    <div class="border-t border-gray-200 pt-8 dark:border-gray-700">
        ...
        <div class="mb-5 flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ __('Upload the official logo of the university.') }}
                </p>
