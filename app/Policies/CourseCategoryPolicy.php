...
class CourseCategoryPolicy
{
    ...
    {
        return $user->hasPermissionTo('view-course-categories');
    }
    ...
    {
        return $user->hasPermissionTo('create-course-categories');
    }
    ...
    {
        return $user->hasPermissionTo('edit-course-categories');
    }
    ...
    {
        return $user->hasPermissionTo('delete-course-categories');
    }
