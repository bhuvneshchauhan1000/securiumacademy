    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden bg-white dark:bg-gray-800 shadow-sm ring-1 ring-gray-200 dark:ring-gray-700 sm:rounded-xl">
                ...
                {{-- Header --}}
                {{-- ========================================================= --}}
                <div class="flex flex-col gap-4 bg-gradient-to-r from-teal-500 via-teal-500 to-cyan-500 px-6 py-5 sm:px-8 lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <h3 class="text-lg font-semibold text-white">
                                {{ __('Partners Management') }}
                            </h3>

                            <p class="text-sm text-teal-100">
                                {{ __('Create, edit and manage partners.') }}
                            </p>
                        ...
                        <div class="flex flex-col items-center justify-center text-center">
                            ...
                            <p class="mt-2 max-w-md text-sm text-gray-500 dark:text-gray-400">
                                ...
                                @if (request('search'))
                                    ...
                                    {{ __('No partners matched your search. Try a different keyword.') }}

                                @else

                                    {{ __('You don\'t have any partners yet. Create your first partner to get started.') }}
                                ...
                                @foreach ($partners as $partner)
                                    ...
                                    <tr class="transition hover:bg-teal-50/50 dark:hover:bg-teal-900/10">
                                            ...
                                            <div class="flex items-center gap-3">
                                                ...
                                                @if ($partner->logo)
                                                    ...
                                                    <img
                                                        ...
                                                        alt="{{ $partner->name }}"
                                                        class="h-12 w-12 shrink-0 rounded-lg object-contain ring-1 ring-gray-200 dark:ring-gray-700"
                                                    >
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            <span class="inline-flex items-center rounded-full bg-teal-100 px-2.5 py-1 text-xs font-medium text-teal-600 dark:bg-teal-900/50 dark:text-teal-300">
                                        ...
                                        <td class="px-6 py-4 text-right text-sm whitespace-nowrap">
                                            ...
                                            <div class="flex items-center justify-end gap-2">
                                                ...
                                                @can('edit-partners')
                                                    ...
                                                    <a href="{{ route('partners.edit', \App\Support\HashId::encode($partner->id)) }}"
                                                ...
                                                @can('delete-partners')
                                                    ...
                                                    <form
                                                        method="POST"
                                                        action="{{ route('partners.destroy', \App\Support\HashId::encode($partner->id)) }}"
                                                        class="inline"
