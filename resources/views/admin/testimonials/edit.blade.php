    ...
    <div class="py-12">
        ...
        <div class="mx-auto max-w-6xl sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden bg-white shadow-sm ring-1 ring-gray-200 dark:bg-gray-800 dark:ring-gray-700 sm:rounded-xl">
                ...
                <div class="bg-gradient-to-r from-indigo-500 via-indigo-500 to-purple-500 px-6 py-5 sm:px-8">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-indigo-100">
                                {{ __('Update and manage this testimonial.') }}
                            </p>
                ...
                <form
                    method="POST"
                    action="{{ route('testimonials.update', \App\Support\HashId::encode($testimonial->id)) }}"
