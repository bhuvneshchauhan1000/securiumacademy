...
<div class="space-y-8">
    ...
    @if ($errors->any())
        ...
        <div class="rounded-lg border border-red-200 bg-red-50 p-4 dark:border-red-800 dark:bg-red-900/20">
            ...
            <div class="flex gap-3">
                ...
                <svg class="mt-0.5 h-5 w-5 shrink-0 text-red-600 dark:text-red-400" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
    ...
    <div>
        ...
        <div>
            ...
            <input id="name" name="name" type="text" value="{{ old('name', $course->name ?? '') }}" required autofocus
        ...
        <div class="mt-5">
            ...
            @if ($isEdit)
                ...
                <input id="slug" name="slug" type="text" value="{{ old('slug', $course->slug ?? '') }}" readonly
            ...
            @else
                ...
                <div class="rounded-lg bg-sky-50 p-4 dark:bg-sky-900/20">
                    ...
                    <div class="flex gap-3">
                        ...
                        <svg class="mt-0.5 h-5 w-5 shrink-0 text-sky-600 dark:text-sky-300" fill="none"
        ...
        <div class="mt-5">
            ...
            <textarea id="content" name="content" rows="10" placeholder="{{ __('Write the full course content...') }}"
    ...
    <div class="border-t border-gray-200 pt-8 dark:border-gray-700">
        ...
        <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
            ...
            <div>
                ...
                <label for="course_category_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                ...
                <select id="course_category_id" name="course_category_id" required
                    ...
                    @foreach ($courseCategories as $category)
                        ...
                        <option value="{{ $category->id }}" @selected((string) old('course_category_id', $course->course_category_id ?? '') === (string) $category->id)>
                            {{ $category->name }}
                        </option>
            ...
            <div>
                ...
                <label for="course_level" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                ...
                <select id="course_level" name="course_level"
                    ...
                    <option value="beginner" @selected(old('course_level', $course->course_level ?? '') === 'beginner')>
                        {{ __('Beginner') }}
                    </option>

                    <option value="intermediate" @selected(old('course_level', $course->course_level ?? '') === 'intermediate')>
                        {{ __('Intermediate') }}
                    </option>

                    <option value="advanced" @selected(old('course_level', $course->course_level ?? '') === 'advanced')>
                        {{ __('Advanced') }}
                    </option>

                    <option value="expert" @selected(old('course_level', $course->course_level ?? '') === 'expert')>
                        {{ __('Expert') }}
                    </option>
            ...
            <div>
                ...
                <input id="duration" name="duration" type="text" value="{{ old('duration', $course->duration ?? '') }}"
            ...
            <div>
                ...
                <select id="status" name="status" required
                    ...
                    <option value="draft" @selected(old('status', $course->status ?? '') === 'draft')>
                        {{ __('Draft') }}
                    </option>
        ...
        <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
            ...
            <div>
                ...
                <input id="fee" name="fee" type="number" step="0.01" min="0"
                    value="{{ old('fee', $course->fee ?? '') }}" placeholder="{{ __('0.00') }}"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-sky-500 focus:ring-sky-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:placeholder-gray-500">
            ...
            <div>
                ...
                <label for="discount_fee" class="block text-sm font-medium text-gray-700 dark:text-gray-300">

                    {{ __('Discounted Fee') }}

                </label>

                <input id="discount_fee" name="discount_fee" type="number" step="0.01" min="0"
                    value="{{ old('discount_fee', $course->discount_fee ?? '') }}" placeholder="{{ __('0.00') }}"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-sky-500 focus:ring-sky-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:placeholder-gray-500">
    ...
    <div class="border-t border-gray-200 pt-8 dark:border-gray-700">
        ...
        <div class="mb-5 flex items-center gap-3">
            ...
            <div class="flex h-9 w-9 items-center justify-center rounded-lg bg-sky-100 dark:bg-sky-900/50">
                ...
                <svg class="h-5 w-5 text-sky-600 dark:text-sky-300" fill="none" stroke="currentColor"
                    ...
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l1.5 1.5L22 9">
                    </path>
        ...
        <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
            ...
            <div>
                ...
                <label for="certification" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
            ...
            <div>
                ...
                <label for="certificate_image" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                ...
                <input id="certificate_image" name="certificate_image" type="file"
                    accept="image/jpeg,image/png,image/webp,image/jpg,image/svg+xml" class="mt-1 block w-full text-sm text-gray-500 dark:text-gray-400
                ...
                @if ($isEdit && $course->certificate_image)
                    ...
                    <div class="mt-3">
                        ...
                        <img src="{{ Storage::url($course->certificate_image) }}" alt="{{ __('Certificate') }}"
    ...
    <div class="border-t border-gray-200 pt-8 dark:border-gray-700">
        ...
        @if ($isEdit && $course->featured_image)
            ...
            <div class="mb-5">
                ...
                <div class="inline-flex rounded-xl bg-gray-50 p-4 ring-1 ring-gray-200 dark:bg-gray-900 dark:ring-gray-700">
                    ...
                    <img src="{{ Storage::url($course->featured_image) }}" alt="{{ $course->name }}"
        ...
        <input id="featured_image" name="featured_image" type="file" accept="image/jpeg,image/png,image/webp,image/jpg"
    ...
    <div class="border-t border-gray-200 pt-8 dark:border-gray-700">
        ...
        <div>
            ...
            <input id="meta_title" name="meta_title" type="text"
                value="{{ old('meta_title', $course->meta_title ?? '') }}" placeholder="{{ __('Enter SEO title...') }}"
                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-sky-500 focus:ring-sky-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:placeholder-gray-500">
        ...
        <div class="mt-5">
            ...
            <label for="meta_script" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
            ...
            <div class="flex items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <label for="is_featured" class="text-sm font-medium text-sky-900 dark:text-sky-200">
                ...
                <label class="relative inline-flex cursor-pointer items-center">
                    ...
                    <input type="checkbox" id="is_featured" name="is_featured" value="1" class="peer sr-only"
                        @checked(old('is_featured', $course->is_featured ?? false))>

                    <div
                        class="h-6 w-11 rounded-full bg-gray-200 peer-checked:bg-sky-600 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-sky-300 dark:bg-gray-700 dark:peer-focus:ring-sky-800
                        after:absolute after:left-[2px] after:top-[2px] after:h-5 after:w-5 after:rounded-full after:border after:border-gray-300 after:bg-white after:transition-all after:content-[''] peer-checked:after:translate-x-full peer-checked:after:border-white">
                    </div>
