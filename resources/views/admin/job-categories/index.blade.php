    ...
    <div class="py-12">
        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden bg-white dark:bg-gray-800 shadow-sm ring-1 ring-gray-200 dark:ring-gray-700 sm:rounded-xl">
                ...
                <div class="flex flex-col gap-4 bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 px-6 py-5 sm:px-8 lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <h3 class="text-lg font-semibold text-white">
                                {{ __('Job Category Management') }}
                            </h3>

                            <p class="text-sm text-emerald-100">
                                {{ __('Create, edit and manage job categories.') }}
                            </p>
                    ...
                    <div class="flex flex-col gap-2 sm:flex-row sm:items-center">
                        ...
                        {{-- Search --}}
                        <form method="GET"
                            action="{{ route('job-categories.index') }}"
                            ...
                            <div class="relative">
                                ...
                                <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                                    ...
                                    <svg class="h-4 w-4 text-emerald-100"
                                        fill="none"
                                        stroke="currentColor"
                                        viewBox="0 0 24 24">
                                ...
                                <input
                                    ...
                                    class="block w-full rounded-md border-transparent bg-white/20 py-2 pl-9 pr-3 text-sm text-white placeholder-emerald-100 shadow-sm backdrop-blur focus:border-white focus:bg-white/30 focus:ring-0 sm:w-56"
                                >
                        ...
                        <div class="flex flex-col items-center justify-center text-center">
                            ...
                            <p class="mt-2 max-w-md text-sm text-gray-500 dark:text-gray-400">
                                ...
                                @if (request('search'))
                                    ...
                                    {{ __('No job categories matched your search. Try a different keyword.') }}

                                @else

                                    {{ __("You don't have any job categories yet. Create your first category to get started.") }}
                                    ...
                                    <tr class="transition hover:bg-emerald-50/50 dark:hover:bg-emerald-900/10">
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div class="flex h-12 w-12 shrink-0 items-center justify-center rounded-lg bg-emerald-100 text-emerald-600 dark:bg-emerald-900/50 dark:text-emerald-300">
                                        ...
                                        <td class="px-6 py-4 text-right text-sm whitespace-nowrap">
                                            ...
                                            <div class="flex items-center justify-end gap-2">
                                                ...
                                                @can('edit-job-categories')
                                                    ...
                                                    <a href="{{ route('job-categories.edit', \App\Support\HashId::encode($jobCategory->id)) }}"
                                                ...
                                                @can('delete-job-categories')
                                                    ...
                                                    <form
                                                        method="POST"
                                                        action="{{ route('job-categories.destroy', \App\Support\HashId::encode($jobCategory->id)) }}"
                                                        class="inline"
                                                        onsubmit="return confirm('{{ __('Are you sure you want to delete this job category?') }}');"
                                                    >
