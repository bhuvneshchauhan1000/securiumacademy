...
class JobCategoryPolicy
{
    ...
    {
        return $user->hasPermissionTo('view-job-categories');
    }
    ...
    {
        return $user->hasPermissionTo('create-job-categories');
    }
    ...
    {
        return $user->hasPermissionTo('edit-job-categories');
    }
    ...
    {
        return $user->hasPermissionTo('delete-job-categories');
    }
